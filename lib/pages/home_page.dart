...
import 'package:electronics_shop_app/pages/topDetails.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          children: [
            Image(image: AssetImage("assets/image/electronics_logo.png"),height: 50,color: Colors.black,),
            Text("Electronics", style: GoogleFonts.alegreyaSc(
              fontSize: 26,
